    ...
    <div class="card">
        ...
        <div class="card-header actions-toolbar border-0">
            <div class="d-flex justify-content-between align-items-center">
                <h4 class="d-inline-block mb-0">السطاجات</h4>
                <div class="d-flex">
                    ...
                    <tr>
                        ...
                        <th scope="row">
                            <div class="media align-items-center">
                                ...
                                <div class="media-body mr-4">
                                    ...
                                    <a href="#" class="name h6 mb-0 text-sm">{{$stage->title}}
                        ...
                        <td class="text-right">
                            <!-- Actions -->
                                    ...
                                    <a href="  {{route("admin.stage.remove",$stage->id)}}  " class="button delete-confirm" class="btn btn-icon btn-hover btn-lg btn-circle"  uk-tooltip="مسح السؤال" title="" aria-expanded="false">
