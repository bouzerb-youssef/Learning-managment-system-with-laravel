          ...
          {{--   <div class="uk-width-1-4@m uk-flex-last@m uk-first-column">
            ...
            <div class="uk-width-2-4@m">
                ...
                <div class="card rounded">
                    ...
                    <hr class="m-0">
                    <form action="{{route("admin.formation.update",$formation->id)}}"  class="uk-child-width-1-2@s uk-grid-small p-4 uk-grid" method="POST">
                        {{ csrf_field() }}
                                <div class="uk-grid-margin">
                                    <h5 class="uk-text-bold mb-2"> الاسم</h5>
                                    <input type="text" class="uk-input" value="{{$formation->title}}" name="title" placeholder="الاسم ">
                                </div>
                        
                             
                                <div class="uk-grid-margin">
                                    <h5 class="uk-text-bold mb-2"> تاريخ البدأ* </h5>
                                    <input type="date" name="datebegun" value="{{$formation->datebegun}}" id="birthDate" class="form-control">
                                </div>
                                <div class="uk-grid-margin">
                                    <h5 class="uk-text-bold mb-2"> تاريخ الانتهاء* </h5>
                                    <input type="date" name="dateend" value="{{$formation->dateend}}" id="birthDate" class="form-control">
                                </div>
