                    ...
                    <form  action="{{route("admin.section.update",$section->id)}}" method="POST">
                                    ...
                                    <div class="uk-child-width-1-2@s uk-grid-small p-4 uk-grid" uk-grid=""> 
                                        <div class="uk-first-column">
                                            ...
                                            <input type="text" class="uk-input" name="section" value="{{$section->section}}" placeholder="الاسم الكامل">
                                        </div>
                                        <div class="uk-first-column">
                                            
                                            <input type="hidden" class="uk-input" name="cource_id" value='{{$section->cource_id}}' placeholder="الاسم الكامل">
                                        </div>
                                    ...
                                    <div  class='container' class="uk-grid-margin uk-first-column" >
                                        ...
                                        <textarea  name="description" class="mytextarea"  placeholder="الملاحضات"   class="form-control">{{$section->description}}</textarea>
                                    </div>                            
