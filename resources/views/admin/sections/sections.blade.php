                                    ...
                                    <li  @if ($loop->first) class="uk-open" @endif >
                                        ...
                                        <a class="uk-accordion-title" href="#"> {{$section->section}}
                                         ...
                                         <div class="action-btn">
                                            ...
                                            <a href="{{route('admin.lesson.add',$section->id)}}" {{-- class="btn btn-icon btn-hover btn-sl btn-circle"  --}}uk-tooltip="اضافة درس" title="" aria-expanded="false">
                                    ...
                                    <li  @if ($loop->first) class="uk-open" @endif >
                                        ...
                                        <a class="uk-accordion-title" href="#"> {{$section->section}}
                                         ...
                                         <div class="action-btn">
                                            ...
                                            <a href="{{route('admin.material.add',$section->id)}}"  uk-tooltip="اضافة مرفق" title="" aria-expanded="false">
                                                <i class="icon-material-outline-attach-file"></i> 
                                            </a>
                                            <a href="{{route('admin.editsection',$section->id)}}"   uk-tooltip="تعديل الفصل" title="" aria-expanded="false">
                                                <i class="uil-pen "></i> 
                                            </a>
                                        </div>
                                        <div class="uk-accordion-content" aria-hidden="false">
                                            ...
                                            <li>
                                                ...
                                                <span>     
                                                    ...
                                                    <div class="action-btn"   >
                                                        <a href="{{route('admin.material.remove',$material->id)}}"    class="delete-confirm"   uk-tooltip="مسح الفصل" title="" aria-expanded="false">
                                                            <i class="uil-trash-alt text-danger"></i> 
                                                        </a>
                                                      
                                                        <a href="{{route('admin.material.edit',$material->id)}}"   {{-- class="btn btn-icon btn-hover btn-lg btn-circle"  --}}uk-tooltip="تعديل الفصل" title="" aria-expanded="false">
                                                            <i class="uil-pen   "></i> 
                                                        </a>
                                                    </div>
                                            </span>
