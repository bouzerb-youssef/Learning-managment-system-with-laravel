                    ...
                    <form  action="{{route("admin.addcource.store")}}" method="POST" enctype="multipart/form-data" >
                              ...
                              <div class="uk-grid-margin uk-first-column">
                                <h5 class="uk-text-bold mb-2">Image </h5>
                                  <div class="uk-margin"> 
                                 <div class="uk-margin" uk-margin> <div uk-form-custom="target: true"> <input type="file" name='thumbnail'> <input class="uk-input uk-form-width-medium" type="text" placeholder="Select file" disabled> </div>  
                                </div>
                            </div>  
                            </div> 
                        </div> 
                            ...
                            <div class="uk-child-width-2-6@s uk-grid-small p-4 uk-grid" uk-grid="">
                                <div class="uk-grid-margin uk-first-column">
                                    ...
                                    <textarea  name="description" {{-- class="mytextarea" --}}  placeholder="short description"   class="form-control"></textarea>
                                </div>
                            </div>
