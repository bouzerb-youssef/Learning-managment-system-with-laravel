        ...
        <div uk-grid="" class="uk-grid">
            ...
            <div class="uk-width-2-4@m">
                ...
                <div class="card rounded">
                    ...
                    <hr class="m-0">
                    <form  action="{{route("admin.addcource.store")}}" method="POST" enctype="multipart/form-data" class="uk-child-width-1-2@s uk-grid-small p-4 uk-grid" uk-grid="">
                                    {{ csrf_field() }}
                                ...
                                <div class="uk-grid-margin uk-first-column">
                                    ...
                                    <textarea  name="short_description" class="mytextarea"  placeholder="الملاحضات"   class="form-control"></textarea>
                                </div>
                                ...
                                <div class="uk-grid-margin uk-first-column">
                                    ...
                                    <textarea  name="detail" class="mytextarea"  placeholder="الملاحضات"   class="form-control"></textarea>
                                </div>
                                <div class="uk-grid-margin uk-first-column">
                                ...
                                <form> 
                                    <div class="uk-margin"> 
                                        <div uk-form-custom> 
                                            <input type="file"> 
                                            <button class="uk-uk-button uk-button-default" type="button" tabindex="-1">Select</button> 
                                        </div> </div> <div class="uk-margin"> 
                                            <span class="uk-text-middle">Here is a text</span> 
                                            <div uk-form-custom> <input type="file"> 
                                        ...
                                        <div class="uk-margin" uk-margin> 
                                            ...
                                            </div> <button class="uk-uk-button uk-button-default">Submit</button> 
                                        </div> </form>
