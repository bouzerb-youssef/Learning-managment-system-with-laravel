    ...
    <div class="page-content-inner">
        ...
        <div class="card">
            ...
            <ul class="uk-child-width-expand uk-tab" uk-switcher="connect: #course-edit-tab ; animation: uk-animation-slide-left-medium, uk-animation-slide-right-medium">
                <li class="uk-active"><a href="#" aria-expanded="true"> اضافة درس</a></li>
                <li class=""><a href="#" aria-expanded="true"> اضافة الادوات</a></li>
                <li class=""><a href="#" aria-expanded="true"> اضافةامتحان</a></li>
            ...
            <div class="card-body">
                ...
                <ul class="uk-switcher uk-margin" id="course-edit-tab" style="touch-action: pan-y pinch-zoom;">
                                ...
                                <li class="uk-active">
                                    ...
                                    @livewire('admin.addlesson', ['section' => $section])          
